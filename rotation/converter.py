...
def ja_to_html(output_path: str, trees: list[Tree]):
    ...
    with open(output_path, "w") as f:
        for tree in trees:
            ...
            result += (
                f'<math xmlns="http://www.w3.org/1998/Math/MathML">{tree_str}</math>'
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", choices=["CCGBank", "parsed"], default="CCGBank")
    parser.add_argument("--output", choices=["html", "auto"], default="html")
